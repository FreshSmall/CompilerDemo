...
import com.compiler.report.PlayReportBaseVisitor;
...
public class FieldEvaluator extends PlayReportBaseVisitor<Object> {
    ...
    @Override
    public Object visitBracedExpression(PlayReportParser.BracedExpressionContext ctx) {
        return visitExpression(ctx.expression());
    }

    @Override
    public Object visitExpression(PlayReportParser.ExpressionContext ctx) {
        Object rtn = null;
    ...
    @Override
    public Object visitPrimary(PlayReportParser.PrimaryContext ctx) {
        Object rtn = null;
        if (ctx.literal() != null) {
    ...
    @Override
    public Object visitLiteral(PlayReportParser.LiteralContext ctx) {
        Object rtn = null;
    ...
    @Override
    public Object visitFloatLiteral(PlayReportParser.FloatLiteralContext ctx) {
        return Float.valueOf(ctx.getText());
    }

    @Override
    public Object visitIntegerLiteral(PlayReportParser.IntegerLiteralContext ctx) {
        Object rtn = null;
    ...
    @Override
    public Object visitFunctionCall(PlayReportParser.FunctionCallContext ctx) {
        Object rtn = null;
    ...
    @Override
    public Object visitExpressionList(PlayReportParser.ExpressionListContext ctx) {
        Object rtn = null;
    ...
    // 求排序值（向量）
    private Object rank(PlayReportParser.FunctionCallContext ctx) {
        Object rtn = null;
    ...
    // 求最大值（标量）
    private Object max(PlayReportParser.FunctionCallContext ctx) {
        Object rtn = null;
        String functionFieldName = ctx.getText();
    ...
    // 求汇总值（标量）
    private Object sum(PlayReportParser.FunctionCallContext ctx) {
        Object rtn = null;
        String functionFieldName = ctx.getText();
    ...
    // 求累计汇总值（向量）
    private Object runningSum(PlayReportParser.FunctionCallContext ctx) {
        Object rtn = null;
        String functionFieldName = ctx.getText();
    ...
    // 根据公式，往数据源里添加一个计算字段
    private void addCalculatedField(PlayReportParser.ExpressionContext ctx) {
